...
while True:
    ...
    def printStartScreen():
        ...
        The start screen contains the name of the game and a prompt to 
    ...
    while itteration:
        ...
        #This is a developer tool, it just shows the location of the ship
        if developer:
            sleep(.2)
            print ship_col
            sleep(.2) 
        ...
        #Asking for input and seeing if they're trying to quit
        col_guess = raw_input('\nGuess a collumn: ')
        ...
        #Handling input:
        #For if one fo the spots is left blank:
        ...
        #If they guess outside of the board
        ...
        #If none of the others are true and they're just plain wrong
        else:
    ...
    #End sequence for if the game has been won.
    if itteration == False:
        if ngCounter == 6:
            break
            restartLoop = False
